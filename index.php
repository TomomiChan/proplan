...
<head>
    ...
    <link rel="stylesheet" href="html_php_css/style.css">
...
<div id="hauptbereich">
	...
	<form id="formular" method="POST" action="html_php_css/login.php">
		<table>
			<tr>
				<td id="username">
		...
		<form id="formular1" action="html_php_css/registrierung.php">		<!--hier eigentlich script !-->
